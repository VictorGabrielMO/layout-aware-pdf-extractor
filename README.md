...
As primeiras requisições de um tipo de documento serão lentas (Extração de regexes pelo LLM é custosa), mas o sistema convergirá rapidamente para tempo de execução baixo conforme acumula conhecimento.
